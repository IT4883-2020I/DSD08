...
const TypeTask = () => {
    ...
    const [dataEdit, setDataEdit] = useState({ name: '', description: '', employee_number: 0, prioritize: 0 });
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (text, record) => <p>{codeIncidents[record.project_type].name}</p>,
            filters: [
                {
    ...
    const addData = () => {
        setDataEdit({ name: '', description: '', employee_number: 0, prioritize: 0 });
    ...
    return (
        ...
        <div>
            ...
            >
                <p>Tên công việc</p>
                <Input value={dataEdit.name} onChange={(e) => onChangeValue("name", e.target.value)} />

                <p style={{ marginTop: 20 }}>Nội dung công việc</p>
                <Input value={dataEdit.description} onChange={(e) => onChangeValue("description", e.target.value)} />

                <p style={{ marginTop: 20 }}>Số lượng nhân viêc</p>
                <Input value={dataEdit.employee_number} type="number" onChange={(e) => onChangeValue("employee_number", e.target.value)} />
                ...
                <Select defaultValue={dataEdit.prioritize}  onChange={(e) => onChangeValue("prioritize", e)} style={{width:'100%'}}>
                    <Option value={true}>true</Option>
                    <Option value={false}>false</Option>
                </Select>

                <Button type="primary" onClick={submitEditData} style={{ marginTop: 20 }}>
                    Submit
                </Button>
            </Modal>
            ...
            >
                ...
                <Button type="primary" onClick={submitAddData} style={{ marginTop: 20 }}>
                    Submit
                </Button>
            </Modal>
        </div>
